...
healthcheck(callback) {
 this.getRecord((result, error) => {
   ...
   if (error) {
      ...
      */
      this.emitOffline();
      log.error ('Healthcheck Error: ' + this.id);
      Console.log('Healthcheck Error: ' + this.id);
   } else {
     /**
      * Write this block.
      ...
      */
      this.emitOnline();
      log.info ('Healthcheck Successful: ' + this.id);
      Console.log('Healthcheck Successful: ' + this.id);
   }
 });
}
  /**
